...
export default function SignupPage() {
  ...
  const registerUser = async (data) => {
    ...
    try {
      ...
      console.log(error);
      toast.error(error.response?.data?.message || "Failed to create account. Please try again.", { position: "bottom-right" });
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-md w-full">
          ...
          <form action={registerUser} className="space-y-6">
            ...
            <div>
              <label
                htmlFor="firstName"
                className="block text-sm font-medium text-white bg-gray-60 mb-2"
              >
                First Name
              </label>
              <input
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-900 text-gray-50">
